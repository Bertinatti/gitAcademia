...
namespace DesafioFINAL.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "O navegador atual foi esquecido.Quando você fizer login novamente, a partir deste navegador, será solicitado seu código de autenticação em dois fatores 2FA.";
